...
if (isset($_POST["submit"])) {
  if (empty($_POST["name"])) {
      header("Location: edit-menu.php?id=$id&msg=Please fill in all fields");
      return;
  }
      ...
      <form action="" method="post" style="width:50vw; min-width:300px;">
        <div class="row mb-3">
          ...
          <div class="col mb-3">
            ...
            <input type="datetime-local" class="form-control" name="DateUpdated" value="<?php echo isset($row['DateUpdated']) ? $row['DateUpdated'] : ''; ?>">
          </div>
        </div>
